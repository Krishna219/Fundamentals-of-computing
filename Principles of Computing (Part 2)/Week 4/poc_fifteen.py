...
#            print (target_row, col),
    ...
    def position_tile(self, tile_pos, req_pos):
        ...
        assert self.get_number(req_pos[0], req_pos[1]) == 0, "Required position is non-zero"
...
#            tot_moves += move
    ...
    def solve_interior_tile(self, target_row, target_col):
        ...
        tot_moves = self.position_tile((target_row, target_col),(target_row, target_col))
#        #find relative position of target tile with respect to zero tile
...
#        print tot_moves
        ...
        if current_position != (target_row, target_col):
            move = self.position_tile((target_row, target_col), current_zero_position)
            tot_moves += move
                    
            #set of moves to solve a 3x2 puzzle
            move = "ruldrdlurdluurddlur" 
            tot_moves += move
        
        move = ""
        #move zero tile to the end
        for dummy_i in range(1, self._width - 1):
            move += "r"                
        tot_moves += move
            
        self.update_puzzle(tot_moves[2:])
#        print str(self)
#        print tot_moves
...
#        print self._grid[target_row][target_col] != 0
        ...
        #check whether (1,j) is solved
#        print self.current_position(target_row + 1, target_col)!=(target_row + 1, target_col)
        if self.current_position(target_row + 1, target_col) != (target_row + 1, target_col):
            return False
...
#my_puzzle2 = Puzzle(3, 3, [[3, 2, 1], [5, 6, 4], [0, 7, 8]])
#my_puzzle3 = Puzzle(3, 3, [[3, 2, 1], [5, 4, 6], [0, 7, 8]])
#
#print my_puzzle1
#str1 = my_puzzle1.solve_col0_tile(2) #urr
#print str1 
#print "Test #1 :", "Success" if str1 == "urr" else "Failure"
#print
#print my_puzzle2
#str2 = my_puzzle2.solve_col0_tile(2) #urr
#print str2 
#print "Test #2 :", "Success" if str2 == "urlruldrdlurdluurddlurr" else "Failure"
#print
#print my_puzzle3
#str3 = my_puzzle3.solve_col0_tile(2) #urr
#print str3 
#print "Test #3 :", "Success" if str3 == "urrulldruldrdlurdluurddlurr" else "Failure"
#print
#row0 invariant
#my_puzzle1 = Puzzle(3, 3, [[3, 0, 2], [1, 4, 5], [6, 7, 8]])
#print my_puzzle1.row0_invariant(1)