...
def draw(canvas):
    ...
    # draw firing line
    delta = angle_to_vector(firing_angle)
    firing_end = [FIRING_POSITION[0] + FIRING_LINE_LENGTH * delta[0], 
                  FIRING_POSITION[1] - FIRING_LINE_LENGTH * delta[1]]
    canvas.draw_line(FIRING_POSITION, firing_end, 4, "rgb(100, 100, 255)")
